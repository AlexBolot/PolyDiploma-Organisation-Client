...
public interface OrganisationWebService {
    ...
    @WebResult(name = "sucess", targetNamespace = "")
    public boolean setFieldTimeslot(
    ...
    @WebResult(name = "sucess", targetNamespace = "")
    public boolean setDateOfCeremony(
    ...
    @WebResult(name = "sucess", targetNamespace = "")
    public boolean confirmSpeakerAttendance(
