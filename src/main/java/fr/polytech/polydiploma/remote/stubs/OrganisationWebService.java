...
public interface OrganisationWebService {
    ...
    @WebMethod
    @RequestWrapper(localName = "sendMailToHost", targetNamespace = "http://www.polytech.unice.fr/si/4a/isa/polydiploma/organisation", className = "fr.polytech.polydiploma.remote.stubs.SendMailToHost")
    @ResponseWrapper(localName = "sendMailToHostResponse", targetNamespace = "http://www.polytech.unice.fr/si/4a/isa/polydiploma/organisation", className = "fr.polytech.polydiploma.remote.stubs.SendMailToHostResponse")
    public void sendMailToHost(
        @WebParam(name = "mail_host", targetNamespace = "")
